...
@Mapper(componentModel = "spring", uses = {MapperConfig.class, CarMapper.class, PlaneMapper.class, ShipMapper.class}, injectionStrategy = InjectionStrategy.CONSTRUCTOR)
